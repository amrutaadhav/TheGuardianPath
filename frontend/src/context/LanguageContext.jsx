...
export const translations = {
  en: {
    ...
    aiScamTitle: "Fake Message Practice",
    ...
    deepfakeLabTitle: "Detect AI Generated Images and Voice",
    deepfakeLabDesc: "Learn how scammers use computers to generate fake images and copy the voices of your family.",
  ...
  mr: { // Marathi
    ...
    aiScamTitle: "बनावट मेसेजचा सराव",
    ...
    deepfakeLabTitle: "AI ने बनवलेले फोटो आणि आवाज ओळखा",
    deepfakeLabDesc: "फसवणूक करणारे कॉम्प्युटरचा वापर करून खोटे फोटो कसे बनवतात आणि तुमच्या ओळखीच्या लोकांचा आवाज कसा वापरतात ते शिका.",
